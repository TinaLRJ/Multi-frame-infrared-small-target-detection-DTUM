...
class ACM(nn.Module):
    def __init__(self, in_channels, layers, fuse_mode, tiny=True, classes=1,
...
#     in_channels=3
#     model= ASKCResUNet(in_channels=in_channels, layers=layers, channels=channels, fuse_mode='AsymBi',tiny=False, classes=1)
#
#     model=model.cuda()
